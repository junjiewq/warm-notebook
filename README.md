...
1. **日历**：点选日期写笔记；有笔记的日子显示圆点
2. **全屏富文本**：TinyMCE — 字体颜色/底色、格式刷、表情、粘贴/插入图片、表格、全屏等
3. **学习线**：自建主题（示例种子：PolarDB / Java / 英语，可删可改）；点进主题按时间看全部笔记
4. **日记挂主题**：编辑某天时用标签多选挂上一条或多条学习线
5. **可选模板**：目标 / 学到了 / 主题 / 疑问
6. **导出**：当日、全部（按日）、按主题 → MD / JSON / PDF / DOCX / 图片
